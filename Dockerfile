...
RUN curl -LsS https://deployer.org/deployer.phar -o /usr/local/bin/dep && chmod +x /usr/local/bin/dep

RUN curl -LsS https://phar.phpunit.de/phpunit-7.phar -o /usr/local/bin/phpunit7 && chmod +x /usr/local/bin/phpunit7
RUN ln -s /usr/local/bin/phpunit7 /usr/local/bin/phpunit

RUN curl -LsS https://www.phing.info/get/phing-2.16.1.phar -o /usr/local/bin/phing2 && chmod +x /usr/local/bin/phing2
RUN curl -LsS https://www.phing.info/get/phing-3.0.0-alpha1.phar -o /usr/local/bin/phing3 && chmod +x /usr/local/bin/phing3
